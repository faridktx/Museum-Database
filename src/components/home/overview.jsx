      ...
      <div className="container">
        <div className="overview-grid">
          <div className="overview-content">
            ...
            <p>
              The Curio Collection provides comprehensive tracking capabilities
              for museums of all sizes. Our system helps you maintain detailed
              records of acquisitions, loans, conservation treatments, and
