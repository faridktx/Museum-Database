    ...
    <div className="form-page">
        ...
        <div className="form-card">
            ...
            <div className="input-group">
                ...
                <label className="required" htmlFor="artistID">Artist ID</label>
                <input 
                    type="number" 
                    id="artistID"
            ...
            <div className="container">
                <div className="form-card">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="input-group">
                            <div className="form-group">
                                <label className="required" htmlFor="artistName">Artist Name</label>
                                <input 
                                type="text" 
                                id="artistName"
                                value={formData.artistName}
                        ...
                        <div className="input-group">
                            <div className="form-group">
                                <label className="required" htmlFor="birthDate">Birth Date</label>
                                <input 
                                type="date" 
                                id="birthDate"
                                value={formData.birthDate}
