    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "0.98rem", color: "#333" }}>
          ...
          <Link className="custom-link" href="/support-contact">
      ...
      >
        ...
        <Link className="custom-link" href="/support-report">
          Submit a Report →
        </Link>
      </section>
      ...
      >
        ...
        <ul className="styled-list">
          <li>
            <Link className="custom-link" href="/support-docs">
              Platform Documentation
            </Link>
          </li>
          <li>
            <Link className="custom-link" href="/support-tutorials">
              Tutorial Library
            </Link>
          </li>
          <li>
            <Link className="custom-link" href="/support-knowledge">
      ...
      >
        ...
        <p style={{ fontSize: "0.98rem", color: "#333" }}>You can also:</p>
        <ul className="styled-list">
