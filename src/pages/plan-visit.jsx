    ...
    <div className="plan-visit-page container">
      ...
      <div className="visit-grid">
        <div className="visit-card">
          <h3>
            <FaClock /> Hours & Location
          </h3>
          <p>Monday – Friday: 9am – 5pm</p>
          <p>Saturday – Sunday: 9am – 6pm</p>
          <p>Last entry is 1 hour before closing</p>
          <p>
            <FaMapMarkerAlt /> 123 Curio Blvd, Houston, TX 77004
          </p>
        </div>

        <div className="visit-card">
          <h3>
            <FaTicketAlt /> Admission
          </h3>
          <li>
            <strong>Child Tickets:</strong> $15.00
          </li>
          <li>
            <strong>Senior Tickets:</strong> $10.00
          </li>
          <li>
            <strong>General Tickets:</strong> $30.00
          </li>
          <li>
            <strong>Children under 3:</strong> Free
          </li>
          <li>
            <strong>Members:</strong> Free
          </li>
        </div>

        <div className="visit-card">
          <h3>
            <FaSubway /> Getting Here
          </h3>
        ...
        <div className="promo-section">
          <div className="promo-card promo-fade">
            ...
            <h3>Buy Tickets</h3>
            <p>
              Plan your next visit and experience our most exciting exhibits.
            </p>
            <a href="/tickets-memberships" className="button promo-button">
              Purchase Tickets
            </a>
          </div>
        </div>
